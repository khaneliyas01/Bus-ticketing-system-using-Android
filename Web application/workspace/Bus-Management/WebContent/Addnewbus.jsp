...
out.println("<script>alert('Please Enter valid date')</script>");
	  ...
	  <li><img src="img/bb.jpg" width="120%" alt=""/></li>								
		...
		<div align="center">
          ...
          <form method="post" action="Addbus" >
            ...
            <tr>
            <td><strong>Bus-no</strong></td><td><input  type="text" name="bno" placeholder="MH14AH1993" required></input></td>
            </tr>
           <tr></tr>
            <tr></tr>
            <tr></tr>
            ...
            <tr></tr>
             ...
             <tr>
            <td><strong>Bus-id</strong></td><td><input  type="text" name="busid" id="busid" placeholder="101" required onkeyup="loadXMLDoc()"></input>&nbsp;&nbsp;&nbsp;&nbsp;
                        <span id="err"> </span></td>
            </tr>
           <tr></tr>
            <tr></tr>
            ...
            <tr>
  <td><strong>Source</strong></td><td><input  type="text" name="source" placeholder="Source" required></input></td>
  ...
  <td><strong>Destination</strong></td><td><input  type="text" name="destination" placeholder="destination" required></input></td>
            ...
            <tr></tr>
             ...
             <tr>
            <td><strong>Date</strong></td><td><input type="text" name="date" id="popupDatepicker" placeholder="01/01/2001" required></input>&nbsp;&nbsp;&nbsp;&nbsp;
                          </span></td> 
            </tr>
           <tr></tr>
            <tr></tr>
