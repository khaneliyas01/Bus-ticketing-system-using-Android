...
<html lang="en">
  <head>
   ...
   <%
	...
	out.println("<script>alert('please enter Correct date ')</script>");
	}
%>
	...
	out.println("<script>alert('Station added successfully ')</script>");
	}
%>
  <body>
	...
	<footer>
					<div class="col-md-4 f-contact">
						...
						<p><i class="fa fa-home"></i> Smart Ambulance System inc  |  PO Box 23456 
